...
class VIT_transformer_updated(nn.Module):
...
if __name__ == "__main__":
    ...
    # Init model
    # model = VIT_transformer_updated(text_max_len=38, teacher_forcing_ratio=0, NUM_WORDS=NUM_WORDS, word2idx=word2idx, return_attn=True, transformer_heads=4)
