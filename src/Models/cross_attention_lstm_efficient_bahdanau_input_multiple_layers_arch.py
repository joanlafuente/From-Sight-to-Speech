...
class cross_attention_lstm_efficient_bahdanau_input_multiple_layers(nn.Module):
    def __init__(self, text_max_len, teacher_forcing_ratio, NUM_WORDS, word2idx, dropout = 0, rnn_layers = 2, return_attn = False, idx2word = None):
        ...
        self.inp_att = nn.Linear(1536*2, 1536).to(self.DEVICE)
...
if __name__ == "__main__":
    ...
    # Init model
    model = cross_attention_lstm_efficient_bahdanau_input_multiple_layers(text_max_len=38, teacher_forcing_ratio=0, NUM_WORDS=NUM_WORDS, word2idx=word2idx)
