...
class lstm_convnext_tiny_bahdanau_hidden_multiple_layers(nn.Module):
...
if __name__ == "__main__":
    ...
    # Init model
    model = lstm_convnext_tiny_bahdanau_hidden_multiple_layers(text_max_len=38, teacher_forcing_ratio=0, NUM_WORDS=NUM_WORDS, word2idx=word2idx)
