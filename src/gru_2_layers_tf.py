...
from Models.two_layers_gru import Teacher_2layersGRU_img_to_word
...
if __name__ == '__main__':
    ...
    with wandb.init(project='Image_Captioning', config=config, name=args.test_name) as run:
        ...
        model = Teacher_2layersGRU_img_to_word(TOTAL_MAX_WORDS, config['teacher_forcing_ratio'], device).to(device)
