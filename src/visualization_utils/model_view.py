...
def model_view(
    ...
    if html_action == 'view':
    ...
    elif html_action == 'return' or html_action == 'save':
        ...
        # Wrap the head_html in a div container with fixed width and height
        head_html = HTML(f'<div style="width: 800px; height: 600px;">{head_html.data}</div>')
