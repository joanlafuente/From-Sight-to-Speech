...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_name', type=str, default='ablation_study_setups/baseline_char_final_resnetall_freeze')
    ...
    config["network"]["params"]["NUM_CHARS"] = NUM_WORDS
    config["network"]["params"]["char2idx"]  = word2idx
    config["network"]["params"]["idx2char"]  = idx2word
    ...
    crit = get_loss(config["loss"], weights=None, device = device)
