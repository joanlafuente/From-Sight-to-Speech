...
model = VIT_transformer_updated_pretrained_linear(text_max_len=38, NUM_WORDS=NUM_WORDS, word2idx=word2idx, teacher_forcing_ratio=0, rnn_layers=4, return_attn=True).to(device)
